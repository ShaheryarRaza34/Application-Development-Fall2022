        ...
        trailing: (widget.productList[widget.index].isSelected == false
          ...
          children: [
            IconButton(
              onPressed: () {
                setState(() {
                  widget.productList[widget.index]._incrementProduct(
...
//               subtitle:Text("This is subtitle"),
//               trailing: (productList[index].isSelected?counterRow(product:productList[index]):IconButton(
//                   onPressed:
//                   (){
//                     setState(() {
...
// }
// class counterRow extends StatefulWidget {
//   const counterRow({Key? key,required this.product}) : super(key: key);
...
//           onPressed: (){
//             setState(() {
//               widget.product._incrementProduct(widget.product);
//             });
//
//             //print(productList[index].productQuantity);
//           },
...
//               }
//               else {
//                 widget.product._decrementProduct(
//                     widget.product);
//               }
//
//             });
